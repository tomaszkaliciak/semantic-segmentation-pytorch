...
__all__ = ['smallHrnetv2']


model_urls = {
    'smallHrnetv2': 'http://sceneparsing.csail.mit.edu/model/pretrained_resnet/hrnetv2_w48-imagenet.pth',
}
...
class HRNetV2(nn.Module):
    def __init__(self, n_class, **kwargs):
        ...
        self.layer1 = self._make_layer(Bottleneck, 64, 64, 2)
...
def smallHrnetv2(pretrained=False, **kwargs):
    model = HRNetV2(n_class=1000, **kwargs)
    if pretrained:
        path = os.path.join('./pretrained', 'hrnet_w18_small_v2_cityscapes_cls19_1024x2048_trainset.pth')
        weights = torch.load(path, map_location=None)
